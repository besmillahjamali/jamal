const translations = {
    "fr": {
        ...
        "about_text": "Récemment formé en tant que développeur web à Yschools, je combine une forte sensibilité graphique avec une base technique solide en intégration web. Je suis spécialisé dans la conception d'interfaces modernes et responsives, en utilisant des technologies comme HTML, CSS et JavaScript. Ma polyvalence s'étend au développement d'applications Android et de bots Python, témoignant de ma capacité à m'adapter à divers projets. Rigoureux, curieux et autonome, je suis prêt à m'investir pleinement au sein d'une équipe dynamique pour relever de nouveaux défis.",
    ...
    "en": {
        ...
        "about_text": "I'm a recently trained web developer from Yschools, blending a strong eye for graphic design with a solid technical foundation in web integration. I specialize in crafting modern, responsive, and user-centered interfaces using technologies like HTML, CSS, and JavaScript. My versatility also includes developing Android applications and Python bots, demonstrating my ability to adapt to a wide range of projects. Detail-oriented, curious, and self-sufficient, I am eager to contribute to a dynamic team and take on new challenges.",
    ...
    "fa": {
        ...
        "about_text": "من یک توسعه دهنده وب هستم که به تازگی در Yschools آموزش دیده ام. من توانایی طراحی گرافیکی قوی را با یک پایه فنی محکم در توسعه وب ترکیب می کنم. تخصص من در ساخت رابط های کاربری مدرن، واکنش‌گرا و کاربرمحور با استفاده از فناوری هایی مانند HTML، CSS و JavaScript است. همچنین توانایی های من شامل توسعه برنامه های اندروید و بات های پایتون نیز می شود که نشان دهنده توانایی من در انطباق با پروژه های متنوع است. من فردی دقیق، کنجکاو و خودکفا هستم و مشتاقم تا به یک تیم پویا بپیوندم و چالش های جدیدی را بپذیرم.",
